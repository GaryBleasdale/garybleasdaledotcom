import { e as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute } from '../chunks/astro/server_wUy6F35M.mjs';
import 'kleur/colors';
...
import { b as basics, $ as $$Layout, a as $$Icon } from '../chunks/Icon_Cibr5VjC.mjs';
...
const $$Git = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `${name}: Git`, "backgroundColor": "#22272d" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div${addAttribute({
    ...
    gap: "10px"
  }, "style")}> <h1>Github-like commit calendar</h1> <div>
